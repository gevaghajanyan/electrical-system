...
/**
 * Linear study path. Ordered by level (beginner → intermediate → advanced),
 * and within each level in the sequence a learner should study them.
 * The array IS the curriculum — prev/next navigation walks it directly.
 */
export const LESSONS: LessonDef[] = [
  // ─── BEGINNER ─── fundamentals first, then tools, then first taste of safety ───
  ...
  // ─── INTERMEDIATE ─── deeper circuit theory, then AC/three-phase, then systems ───
  ...
  // ─── ADVANCED ─── design-level and system-wide engineering ───
